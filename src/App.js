...
class App extends React.Component {
  ...
  handleInstruct(keyPressed) {
    ...
    if (whichButton === 1 && (curInstructNum === 2 || curInstructNum === 3)) {
  ...
  handleResp(keyPressed, timePressed) {
    ...
    // Aleya: where it's determined what is a correct choice
    var correct;
    var response;
    if (this.state.dotDiffLeft > this.state.dotDiffRight && choice === "left") { //Aleya: if left has more dots than right, then left is the correct choice
      response = true;
      correct = 1;
    } else if (
      this.state.dotDiffLeft < this.state.dotDiffRight && // Aleya: and vice versa
      choice === "right"
    ) {
      response = true;
      correct = 1;
  ...
  instructText(instructNum) { //Aleya: stores instructions here sequentially, need to add page about other player here? 
    let instruct_text1 = (
      <div>
        <span>
    ...
    let instruct_text2 = (
      <div>
        <span>
          You will be paired with another employee who will be sorting cards with you
          to ensure we arrive at the best decision.  
          <br /> <br />
          It's important that you both try to be as accurate as possible. If you both choose
          correctly, you will receive a point (+1).
          <br /> <br />
          If you both choose incorrectly, you will lose a point (-1)
          <br /> <br />
          If one of you chooses incorrectly, you'll neither gain nor lose points.
          <br /> <br />
          <center>
            Use the ← and → keys to navigate the pages.
            <br />
    ...
    switch (instructNum) { // Aleya: if we add other pages need to add here
      case 1:
  ...
  trialReset() {
    ...
    var reversals; // Aleya: based on staircase function I think reversals are when there is a change in whether people get it correct or no from 1 trial back to two trials back
    if (s2.reversal) {
  ...
  ///////////////////////////////////////////////////////////////
  // Aleya: this part is where the sequence of the task is. You can turn certain things on and off depending on what part of the task you're on. 
  render() {
    let text;
